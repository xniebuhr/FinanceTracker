...
- **Backend**: ASP.NET Core Web API with Entity Framework and MSSQLLocalDB
...
This project is actively being developed. Core transaction functionality is in place, and authentication is the next major milestone. Clean UI, graphing and deployment will follow.
